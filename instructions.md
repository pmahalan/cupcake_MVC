...
* App will let users input (to the database) names of cupcakes they'd like to eat

* Whenever a user submits a cupcake's name, your app will display it on the left side of the page -- waiting to be devoured.
